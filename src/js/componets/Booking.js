...
class Booking {
  ...
  initTables(event){
    ...
    if(!target.classList.contains(classNames.booking.tableBooked)){
      if(target.classList.contains('table')){
        for(let table of thisBooking.dom.tables){
          if(table.getAttribute('data-table') != target.getAttribute('data-table')){
            table.classList.remove('selected');
          }
        }
        if(target.classList.contains('selected')){
          ...
          thisBooking.selectedTable = Number(target.getAttribute('data-table'));
        }
        console.log(event);
      }
    }
    else{
      alert('Stolik zajety, wybierz inny!');
    }  
  }
  ...
  render(element){
    ...
    thisBooking.dom.mail = thisBooking.dom.wrapper.querySelector(select.booking.address);
